...
// routerCart.post('/:cid/products/:pid', handlePolicies(["user","premium"]), cartController.addProduct)
...
routerCart.get('/:cid', cartController.getProducts)
routerCart.post('/', cartController.addCart)
routerCart.post('/:cid/products/:pid', cartController.addProduct)
routerCart.delete('/:cid/products/:pid', cartController.deleteProduct)
routerCart.delete('/:cid', cartController.deleteProducts)
routerCart.post('/:cid/purchase', cartController.purchaseProducts)
