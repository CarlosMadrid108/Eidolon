...
routerViews.get('/carts/:cid', policies.handlePolicies(["USER"]), viewsController.viewCart)

//http://localhost:8080/views/chat
routerViews.get('/chat', policies.handlePolicies(["USER","ADMIN"]), viewsController.chat)

// adminCoder@coder.com
// adminCod3r123
//http://localhost:8080/views/login
routerViews.get('/login', policies.handlePolicies(["PUBLIC"]),viewsController.login)

//http://localhost:8080/views/register
routerViews.get('/register', policies.handlePolicies(["PUBLIC"]), viewsController.register)
